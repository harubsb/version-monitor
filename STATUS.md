# 📱 バージョン使用期限ステータス
最終更新: **2026-08-28 19:19 JST**（自動(毎日)） ／ 自動更新: 毎日 JST 9:00 頃
...
```diff
- アプリA / Android Target SDK: 現在 35 → 必須 API 36 / 期限 2026-11-01 / あと65日
- アプリA_K / Android Target SDK: 現在 35 → 必須 API 36 / 期限 2026-11-01 / あと65日
- アプリB / Android Target SDK: 現在 33 → 必須 API 36 / 期限 2026-11-01 / あと65日
```
...
| Android Target SDK | 35 | 36 | 2026-11-01 (65日後) | 🟡 |
...
| React | 18.2.0 | 19.2.3 | — | 🟡 |
| New Architecture | 無効 | 有効 | 将来必須化の見込み（要計画） | 🟡 |
| Android Target SDK | 33 | 36 | 2026-11-01 (65日後) | 🟡 |
