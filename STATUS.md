# 📱 バージョン使用期限ステータス
最終更新: **2026-06-24 18:23 JST**（ローカル実行） ／ 自動更新: 毎日 JST 9:00 頃

## ストア要件・最新版（共通・自動取得）
- Android Target SDK 必須: API 35（期限 2025-11-01）
- Apple ビルド要件: Xcode 26 / iOS 18 SDK（期限 2026-04-28）
- 最新: Expo SDK 56 / React Native 0.85.3 / React 19.2.3 / Gradle 9.6.0
...
```diff
- アプリB / Android Target SDK: 現在 33 → 必須 API 35 / 期限 2025-11-01 / 超過235日（申請不可の可能性）
```
...
| 項目 | 現在 | 推奨(最新) | 使用期限 | 状態 |
|------|------|-----------|----------|------|
| Expo SDK | 52 | 56 | サポート中（最新まで 4 世代遅れ） | 🔴 |
| React Native | 0.76.6 | 0.85.3 | — | 🟡 |
| React | 18.3.1 | 19.2.3 | — | 🟡 |
...
| パッケージ | 現在 | 最新 | 種別 |
|------|------|------|------|
| @react-navigation/native | 6.0.6 | 7.3.4 | major |
| @react-navigation/bottom-tabs | 6.0.9 | 7.18.3 | major |
...
| 項目 | 現在 | 推奨(最新) | 使用期限 | 状態 |
|------|------|-----------|----------|------|
| Expo SDK | 53 | 56 | サポート中（最新まで 3 世代遅れ） | 🟡 |
| React Native | 0.79.2 | 0.85.3 | — | 🟡 |
| React | 19.0.0 | 19.2.3 | — | 🟡 |
...
| パッケージ | 現在 | 最新 | 種別 |
|------|------|------|------|
| @react-navigation/native | 7.0.13 | 7.3.4 | minor |
| @react-navigation/bottom-tabs | 7.1.3 | 7.18.3 | minor |
| react-native-safe-area-context | 5.4.0 | 5.8.0 | minor |
| react-native-screens | 4.10.0 | 4.25.2 | minor |
| react-native-reanimated | 3.17.4 | 4.5.0 | major |
| react-native-gesture-handler | 2.24.0 | 3.0.2 | major |

## アプリB
| 項目 | 現在 | 推奨(最新) | 使用期限 | 状態 |
|------|------|-----------|----------|------|
| Expo SDK | 48 | 56 | サポート中（最新まで 8 世代遅れ） | 🔴 |
| React Native | 0.71.6 | 0.85.3 | — | 🟡 |
| React | 18.2.0 | 19.2.3 | — | 🟡 |
| New Architecture | 無効 | 有効 | 将来必須化の見込み（要計画） | 🟡 |
| Android Target SDK | 33 | 35 | 2025-11-01 (超過(235日前)) | ⚫ |
...
| react-native-reanimated | 3.4.2 | 4.5.0 | major |
