# 📱 バージョン使用期限ステータス
最終更新: **2026-08-14 11:09 JST**（自動(毎日)） ／ 自動更新: 毎日 JST 9:00 頃
...
```diff
- アプリA / Android Target SDK: 現在 35 → 必須 API 36 / 期限 2026-11-01 / あと79日
- アプリA_K / Android Target SDK: 現在 35 → 必須 API 36 / 期限 2026-11-01 / あと79日
- アプリB / Android Target SDK: 現在 33 → 必須 API 36 / 期限 2026-11-01 / あと79日
```
...
| Android Target SDK | 35 | 36 | 2026-11-01 (79日後) | 🟡 |
...
| react-native-safe-area-context | 4.12.0 | 5.9.0 | major |
...
| react-native-safe-area-context | 5.4.0 | 5.9.0 | minor |
| react-native-screens | 4.10.0 | 4.27.0 | minor |
| react-native-reanimated | 3.17.4 | 4.5.3 | major |
| react-native-gesture-handler | 2.24.0 | 3.2.0 | major |
...
| React | 18.2.0 | 19.2.3 | — | 🟡 |
| New Architecture | 無効 | 有効 | 将来必須化の見込み（要計画） | 🟡 |
| Android Target SDK | 33 | 36 | 2026-11-01 (79日後) | 🟡 |
...
| @react-navigation/native | 6.0.6 | 7.3.16 | major |
| @react-navigation/bottom-tabs | 6.0.9 | 7.18.16 | major |
| react-native-safe-area-context | 4.5.0 | 5.9.0 | major |
| react-native-screens | 3.20.0 | 4.27.0 | major |
| react-native-reanimated | 3.4.2 | 4.5.3 | major |
| react-native-gesture-handler | 2.12.1 | 3.2.0 | major |
