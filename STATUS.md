# 📱 バージョン使用期限ステータス
最終更新: **2026-09-12 12:48 JST**（自動(毎日)） ／ 自動更新: 毎日 JST 9:00 頃

## ストア要件・最新版（共通・自動取得）
- Android Target SDK 必須: API 36（期限 2026-11-01）
- Apple ビルド要件: Xcode 26 / iOS 18 SDK（期限 2026-04-28）
- 最新: Expo SDK 58 / React Native 0.87.1 / React 19.2.3 / Gradle 9.7.1
...
```diff
- アプリA / Android Target SDK: 現在 35 → 必須 API 36 / 期限 2026-11-01 / あと50日
- アプリA_K / Android Target SDK: 現在 35 → 必須 API 36 / 期限 2026-11-01 / あと50日
- アプリB / Android Target SDK: 現在 33 → 必須 API 36 / 期限 2026-11-01 / あと50日
```
...
| React Native | 0.76.6 | 0.87.1 | — | 🟡 |
| React | 18.3.1 | 19.2.3 | — | 🟡 |
| New Architecture | 無効 | 有効 | 将来必須化の見込み（要計画） | 🟡 |
| Android Target SDK | 35 | 36 | 2026-11-01 (50日後) | 🟡 |
...
| React Native | 0.71.6 | 0.87.1 | — | 🟡 |
| React | 18.2.0 | 19.2.3 | — | 🟡 |
| New Architecture | 無効 | 有効 | 将来必須化の見込み（要計画） | 🟡 |
| Android Target SDK | 33 | 36 | 2026-11-01 (50日後) | 🟡 |
