# 📱 バージョン使用期限ステータス
最終更新: **2026-09-02 12:37 JST**（自動(毎日)） ／ 自動更新: 毎日 JST 9:00 頃

## ストア要件・最新版（共通・自動取得）
- Android Target SDK 必須: API 36（期限 2026-11-01）
- Apple ビルド要件: Xcode 26 / iOS 18 SDK（期限 2026-04-28）
- 最新: Expo SDK 57 / React Native 0.86.3 / React 19.2.3 / Gradle 9.7.1
...
```diff
- アプリA / Android Target SDK: 現在 35 → 必須 API 36 / 期限 2026-11-01 / あと60日
- アプリA_K / Android Target SDK: 現在 35 → 必須 API 36 / 期限 2026-11-01 / あと60日
- アプリB / Android Target SDK: 現在 33 → 必須 API 36 / 期限 2026-11-01 / あと60日
```
...
| React Native | 0.76.6 | 0.86.3 | — | 🟡 |
| React | 18.3.1 | 19.2.3 | — | 🟡 |
| New Architecture | 無効 | 有効 | 将来必須化の見込み（要計画） | 🟡 |
| Android Target SDK | 35 | 36 | 2026-11-01 (60日後) | 🟡 |
...
| パッケージ | 現在 | 最新 | 種別 |
|------|------|------|------|
| @react-navigation/native | 6.0.6 | 7.3.18 | major |
| @react-navigation/bottom-tabs | 6.0.9 | 7.18.18 | major |
| react-native-safe-area-context | 4.12.0 | 5.9.1 | major |
...
| パッケージ | 現在 | 最新 | 種別 |
|------|------|------|------|
| @react-navigation/native | 7.0.13 | 7.3.18 | minor |
| @react-navigation/bottom-tabs | 7.1.3 | 7.18.18 | minor |
| react-native-safe-area-context | 5.4.0 | 5.9.1 | minor |
| react-native-screens | 4.10.0 | 4.27.0 | minor |
| react-native-reanimated | 3.17.4 | 4.6.0 | major |
| react-native-gesture-handler | 2.24.0 | 3.2.1 | major |

## アプリB
| 項目 | 現在 | 推奨(最新) | 使用期限 | 状態 |
|------|------|-----------|----------|------|
| Expo SDK | 48 | 57 | サポート中（最新まで 9 世代遅れ） | 🔴 |
| React Native | 0.71.6 | 0.86.3 | — | 🟡 |
| React | 18.2.0 | 19.2.3 | — | 🟡 |
| New Architecture | 無効 | 有効 | 将来必須化の見込み（要計画） | 🟡 |
| Android Target SDK | 33 | 36 | 2026-11-01 (60日後) | 🟡 |
...
| @react-navigation/native | 6.0.6 | 7.3.18 | major |
| @react-navigation/bottom-tabs | 6.0.9 | 7.18.18 | major |
| react-native-safe-area-context | 4.5.0 | 5.9.1 | major |
| react-native-screens | 3.20.0 | 4.27.0 | major |
| react-native-reanimated | 3.4.2 | 4.6.0 | major |
| react-native-gesture-handler | 2.12.1 | 3.2.1 | major |
