# 📱 バージョン使用期限ステータス
最終更新: **2026-08-22 10:22 JST**（自動(毎日)） ／ 自動更新: 毎日 JST 9:00 頃
...
```diff
- アプリB / Android Target SDK: 現在 33 → 必須 API 35 / 期限 2025-08-31 / 超過356日（申請不可の可能性）
```
...
| React | 18.2.0 | 19.2.3 | — | 🟡 |
| New Architecture | 無効 | 有効 | 将来必須化の見込み（要計画） | 🟡 |
| Android Target SDK | 33 | 35 | 2025-08-31 (超過(356日前)) | ⚫ |
